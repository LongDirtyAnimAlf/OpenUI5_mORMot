...
//Provides class sap.ui.model.mORMot.mORMotListBinding
sap.ui.define([
	'jquery.sap.global', 
	'./ChangeReason',	
	'sap/ui/model/FilterProcessor', 'sap/ui/model/Filter', 'sap/ui/model/FilterType',
	'sap/ui/model/ListBinding',
	'sap/ui/model/Sorter', 'sap/ui/model/SorterProcessor', 
	'./mORMotUtils', './CountMode', './OperationMode'
	], function(jQuery, ChangeReason, FilterProcessor, Filter, FilterType, ListBinding, Sorter, SorterProcessor, mORMotUtils, CountMode, OperationMode) {
    "use strict";  	

	/**
	 * @class
	 * List binding implementation for mORMot format
	 *
	 ...
	 * @param {sap.ui.model.mORMot.CountMode} [mParameters.countMode] defines the count mode of this binding
	 ...
	 *
	 * @public
	 * @alias sap.ui.model.mORMot.mORMotListBinding
	 * @extends sap.ui.model.ListBinding
	 */
	var mORMotListBinding = ListBinding.extend("sap.ui.model.mORMot.mORMotListBinding", /** @lends sap.ui.model.mORMot.mORMotListBinding.prototype */ {
	 ...
	 * @protected
	 */
	mORMotListBinding.prototype.getContexts = function(iStartIndex, iLength, iThreshold) {

		console.log("mORMotListBinding.prototype.getContexts");		
		...
		if (this.bClientOperation) {
			if (!this.aAllKeys && !this.bPendingRequest) {
				this.loadData();
	...
	mORMotListBinding.prototype.getCurrentContexts = function() {
	 ...
	 * @private
	 */
	mORMotListBinding.prototype._getContexts = function(iStartIndex, iLength) {
		var aContexts = [],
		oContext,
		sKey;
	 ...
	 * @private
	 */
	mORMotListBinding.prototype.calculateSection = function(iStartIndex, iLength, iThreshold, aContexts) {
	 ...
	 */
	mORMotListBinding.prototype.setContext = function(oContext) {
		
		console.log("mORMotListBinding.prototype.setContext");		
	 ...
	 * @private
	 */
	mORMotListBinding.prototype.loadData = function(iStartIndex, iLength, bPretend) {
	 ...
	 *
	 */
	mORMotListBinding.prototype.isLengthFinal = function() {
	 ...
	 * @public
	 */
	mORMotListBinding.prototype.getLength = function() {
	 ...
	 * @private
	 */
	mORMotListBinding.prototype._getLength = function() {
		var that = this;
		var sGroupId;
	 ...
	 * @public
	 */
	mORMotListBinding.prototype.refresh = function(bForceUpdate, sGroupId) {
	 ...
	 * @private
	 */
	mORMotListBinding.prototype._refresh = function(bForceUpdate, mChangedEntities, mEntityTypes) {
	 ...
	 * @private
	 */
	mORMotListBinding.prototype._fireRefresh = function(mParameters) {
	 ...
	 * metadata is loaded.
	 *
	 * @returns {sap.ui.model.mORMot.mORMotListBinding} oBinding The binding instance
	 * @public
	 */
	mORMotListBinding.prototype.initialize = function() {
		if (this.bInitial) {
			this.bInitial = false;
			this._initSortersFilters();
	 ...
	 * @private
	 */
	mORMotListBinding.prototype.checkUpdate = function(bForceUpdate, mChangedEntities) {
	 ...
	 * @private
	 */
	mORMotListBinding.prototype.resetData = function() {
		this.aKeys = [];
		this.aAllKeys = null;
		this.iLength = 0;
		this.bLengthFinal = false;
	 ...
	 * @private
	 */
	mORMotListBinding.prototype.abortPendingRequest = function() {
	 ...
	 * @since 1.24
	 */
	mORMotListBinding.prototype.getDownloadUrl = function(sFormat) {
		var aParams = [],
			sPath;
	 ...
	 * @public
	 */
	mORMotListBinding.prototype.sort = function(aSorters, bReturnSuccess) {
	...
	mORMotListBinding.prototype.applySort = function() {
		var that = this,
			oContext;
	...
	mORMotListBinding.prototype.createSortParams = function(aSorters) {
		this.sSortParams = mORMotUtils.createSortParams(aSorters);
	};
	 ...
	 * @public
	 */
	mORMotListBinding.prototype.filter = function(aFilters, sFilterType, bReturnSuccess) {
	...
	mORMotListBinding.prototype.applyFilter = function() {
		var that = this,
			oContext,
			aFilters = this.aFilters.concat(this.aApplicationFilters),
			aConvertedFilters = [];
	...
	mORMotListBinding.prototype.createFilterParams = function(aFilters) {
		this.sFilterParams = mORMotUtils.createFilterParams(aFilters);
	};

	mORMotListBinding.prototype._initSortersFilters = function(){
	...
	mORMotListBinding.prototype.resume = function() {
		this.bIgnoreSuspend = false;
		ListBinding.prototype.resume.apply(this, arguments);
	};

	return mORMotListBinding;
